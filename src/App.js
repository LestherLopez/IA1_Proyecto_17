...
function App() {
    ...
    useEffect(() => {
        async function loadResources() {
            try {
                // Cargar el modelo
                const loadedModel = await tf.loadLayersModel("https://lestherlopez.github.io/IA1_Proyecto_17/build/model/model.json");
                setModel(loadedModel);

                // Cargar palabras, clases e intents
                const wordsResponse = await fetch("https://lestherlopez.github.io/IA1_Proyecto_17/build/words.json");
                setWords(await wordsResponse.json());

                const classesResponse = await fetch("https://lestherlopez.github.io/IA1_Proyecto_17/build/classes.json");
                setClasses(await classesResponse.json());

                const intentsResponse = await fetch("https://lestherlopez.github.io/IA1_Proyecto_17/build/intents.json");
